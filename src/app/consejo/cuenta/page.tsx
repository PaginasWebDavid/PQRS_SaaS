...
export default function ConsejoCuentaPage() {
  ...
  async function read(n: Notice) {
    ...
    if (n.resourceType === 'Pqrs' && n.resourceId) window.location.href = '/consejo?id=' + encodeURIComponent(n.resourceId);
  }
  ...
  return (
    <AdminShell navItems={CONSEJO_NAV} activeKey="cuenta" userName={name || 'Consejo'} userRole="Consejo de Administración" initials={initials || 'CM'} mobileTitle="Mi cuenta">
