...
export default function ConsejoAyudaPage() {
  ...
  return (
    <AdminShell navItems={CONSEJO_NAV} activeKey="ayuda" userName="Consejo" userRole="Consejo de Administración" initials="CM" mobileTitle="Ayuda">
      ...
      <p style={{ fontSize: 13.5, color: COLORS.textSecondary, fontWeight: 500, margin: '0 0 24px' }}>Preguntas frecuentes y soporte para el consejo de administración</p>
